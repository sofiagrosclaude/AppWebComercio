<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="FormularioArticulos.aspx.cs" Inherits="WebAppArticulos.WebForm3" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <%--Requerido para uso de Update Panel--%>
             ...
             <div class="row">
                <div class="col-6">
                    ...
                    <div class="mb-3">
                        ...
                        <asp:DropDownList runat="server" ID="ddlCategoria" Cssclass="btn btn-secondary dropdown-toggle" AutoPostBack="true" ></asp:DropDownList>
                  ...
                  <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                     <ContentTemplate>
                        <div class="mb-3">
                            ...
                            <asp:TextBox runat="server" ID="txtImagenUrl" Cssclass="form-control" Autopostback="true" OnTextChanged="txtImagenUrl_TextChanged" ></asp:TextBox>
                        </div>
                        <div class="mb-3">
                            ...
                            <asp:TextBox runat="server" ID="txtPrecio" Cssclass="form-control" ></asp:TextBox>
                                 ...
                                 <div class="mb-3">
                                   ...
                                   <%if (ConfirmaEliminacion)
                                     ...
                                     {%>
                                        <div class="mb-3">
                                            <asp:Label Text="¿Desea eliminar definitivamente?" runat="server" />
                                           <%-- <asp:CheckBox Text="Check para confirmar" ID="chkConfirmaEliminacion" runat="server" />--%>
                                            <asp:button text="🗑️" CssClass="btn btn-outline-danger" OnClick="btnConfirmaEliminar_Click" ID="btnConfirmaEliminar" runat="server" />
                                        </div>
                                      <% } %>
